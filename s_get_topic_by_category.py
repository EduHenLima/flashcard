...
handler_wrapper_kwargs = {'function_name': 'aws-python-dev-get_topic_by_category', 'timeout': 6}
try:
    user_handler = serverless_sdk.get_user_handler('src/API/topic/getTopicByCategory.get_topic_by_category')
