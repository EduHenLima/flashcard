...
handler_wrapper_kwargs = {'function_name': 'aws-python-dev-update_cards', 'timeout': 6}
try:
    user_handler = serverless_sdk.get_user_handler('src/API/cards/updateCards.update')
