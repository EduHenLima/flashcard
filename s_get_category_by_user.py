...
handler_wrapper_kwargs = {'function_name': 'aws-python-dev-get_category_by_user', 'timeout': 6}
try:
    user_handler = serverless_sdk.get_user_handler('src/API/category/getCategoryByUser.get_category_by_user')
