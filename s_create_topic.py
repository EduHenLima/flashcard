...
handler_wrapper_kwargs = {'function_name': 'aws-python-dev-create_topic', 'timeout': 6}
try:
    user_handler = serverless_sdk.get_user_handler('src/API/topic/createTopic.create')
