...
handler_wrapper_kwargs = {'function_name': 'aws-python-dev-get_cards_by_topic', 'timeout': 6}
try:
    user_handler = serverless_sdk.get_user_handler('src/API/cards/getCardsByTopic.get_cards_by_topic')
